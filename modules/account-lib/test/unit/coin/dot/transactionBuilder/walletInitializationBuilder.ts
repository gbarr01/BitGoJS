...
class StubWalletInitializationBuilder extends WalletInitializationBuilder {
  /**
...
describe('Dot Add Proxy Builder', () => {
  let builder: StubWalletInitializationBuilder;
  ...
  beforeEach(() => {
    ...
    builder = new StubWalletInitializationBuilder(config);
  });
